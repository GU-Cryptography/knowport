                    ...
                    {isEditing ? (
                        ...
                        <input
                          ...
                          onKeyDown={(event) => {
                            ...
                            if (event.key === "Enter") {
                              ...
                              if (
                                !nextTitle ||
                                nextTitle === conversation.title.trim()
                              ) {
                                return;
                              }
                      ...
                      >
                        ...
                        {conversation.knowledgeBaseId && (
                          <span
                            className="conversation-kb-badge"
                            title="对话绑定的知识库"
                          >
                            知识库 ·{" "}
                            {knowledgeBases.find(
                              (kb) => kb.id === conversation.knowledgeBaseId,
                            )?.name ?? "已删除的知识库"}
                          </span>
                        )}
                      </button>
          ...
          {authUser && (
            <div className="sidebar-user">
              <div className="sidebar-user-info">
                ...
                <span className="sidebar-user-name" title={authUser.username}>
                  {authUser.username}
                </span>
              </div>
              <button
