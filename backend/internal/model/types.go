...
type ChatConfig struct {
	...
	// ExtraHeaders is multi-line "Key: Value" text appended to every chat request.
	// Used for provider-specific opt-ins (e.g. `anthropic-beta: context-1m-2025-08-07`)
	// so we never hard-code model behaviour in code.
